...
def run_training():
    ...
    out_dir = '/storage/work/tks5206/10-26/results/'
    initial_checkpoint = \
       '/storage/work/tks5206/10-26/model/00243000_model.pth'
       #None  #
        
 
    pretrained_file = '/storage/work/tks5206/10-26/model/resnet101-5d3b4d8f.pth'
    skip = ['fc.'] #
    ...
    iter_accum = 1
    batch_size = 512 #2*288//iter_accum
    ...
    while  i<num_iters:  # loop over the dataset multiple times
        ...
        for images, labels, indices in train_loader:
            ...
            if i % iter_log == 0:
                ...
                log.write('%0.5f  %5.1f k  %4.2f  %4.2f | %0.4f  %0.4f | %0.4f  %0.4f | %0.4f  %0.4f | %s \n' % \
            ...
            print('\r%0.5f  %5.1f k  %4.2f  %4.2f | %0.4f  %0.4f | %0.4f  %0.4f | %0.4f  %0.4f | %s  %d,%d' % \
                    (rate, i/1000, epoch, num_images/1000000, valid_loss, valid_acc, train_loss, train_acc, batch_loss, batch_acc,
