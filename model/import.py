...
train_data_dir = '/storage/work//tks5206/AnotherOne/train/'
val_data_dir = '/storage/work/tks5206/AnotherOne/val/'
classnames = pickle.load(open("/storage/work//tks5206/AnotherOne/val/", "rb"))
batch_size = 86 * 3  # 258
img_width = 180
img_height = 180
